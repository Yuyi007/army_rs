...
int main (int argc, char **argv) {
  ...
  data[0] = (char *)malloc(sizeof(char) * 255);
  memset(data[0], 0, 255);
  strcpy(data[0], "fcgi/fvfcgi");

  data[1] = (char *)malloc(sizeof(char) * 255);
  memset(data[1], 0, 255);
  strcpy(data[1], "fcgi/main.lua");

  lua_pushlightuserdata(L, data); /* 2nd argument */
