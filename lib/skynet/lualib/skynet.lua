...
function skynet.register_protocol(class)
	-- print("regist protocol ", class.name)
	local name = class.name
	local id = class.id
	-- print(">>>>>name:", name, " id:", id)
	-- print("-----proto[name]:", tostring(proto[name]), " proto[id]:", proto[id])
...
function skynet.cancelable_timeout(ti, func)
  local function cb()
    if func then
      func()
    end
...
skynet.redirect = function(dest,source,typename,...)
	-- print("redirect ", dest, source, typename, proto[typename])
...
function skynet.cancelable_fork(func)
  local function cb()
    if func then
      func()
    end
