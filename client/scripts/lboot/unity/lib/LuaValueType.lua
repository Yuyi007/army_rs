...
local function inherite(cls,base)
  ...
  if not mt then 
    logd("inherite error! %s's meta table not exist", tostring(cls))
    return 
  end
...
do
  ...
  Vector3.__index = function(t,k)
    if DEBUG then
      logd('Vector3.__index k=%s trace=%s', k, debug.traceback())
    end
...
--[[
  ...
  I.__index = function(t,k)
    if DEBUG then
      logd('Vector3 I.__index k=%s trace=%s', k, debug.traceback())
    end
    local f=rawget(I,k)
    if f then return f end
    local f=rawget(get,k)
...
if false then--PLATFORM == 'ios' then
  I.__eq = function(a,b)
  ...
  function Vector3.Min(a,b)
    return Vector3(min(a[1],b[1])
      ,min(a[2],b[2])
      ,min(a[3],b[3]))
  end

  function Vector3.Max(a,b)
    return Vector3(max(a[1],b[1])
      ,max(a[2],b[2])
      ,max(a[3],b[3]))
  end
...
do
  ...
  Color.__index = function(t,k)
    if DEBUG then
      logd('Color.__index k=%s trace=%s', k, debug.traceback())
    end
...
--[[
  ...
  function get.red() return Color(1,0,0,1) end
  function get.green() return Color(0,1,0,1) end
  function get.blue() return Color(0,0,1,1) end
  function get.white() return Color(1,1,1,1) end
  function get.black() return Color(0,0,0,1) end
  function get.yellow() return Color(1, 0.9215686, 0.01568628, 1) end
  function get.cyan() return Color(0,1,1,1) end
  function get.magenta() return Color(1,0,1,1) end
  function get.gray() return Color(0.5,0.5,0.5,1) end
  function get.grey() return Color(0.5,0.5,0.5,1) end
  function get.clear() return Color(0,0,0,0) end
  function get:grayscale() return (0.299 * self[1]) + (0.587 * self[2]) + (0.114 * self[3]) end
  function get:linear()
    return Color(ToLinear(self[1]),ToLinear(self[2]),ToLinear(self[3]),self[4])
  end
  function get:gamma()
    return Color(ToGamma(self[1]),ToGamma(self[2]),ToGamma(self[3]),self[4])
  end
  ...
  function Color.Lerp( a,b,t )
    t=clamp(t)
    return Color( lerpf(a[1],b[1],t),lerpf(a[2],b[2],t),lerpf(a[3],b[3],t),lerpf(a[4],b[4],t) )
  end
...
do
  ...
  Vector2.__index = function(t,k)
    if DEBUG then
      logd('Vector2.__index k=%s trace=%s', k, debug.traceback())
    end
...
if false then--PLATFORM == 'ios' then
  ...
  function get.one() return Vector2(1,1) end
  function get.zero() return Vector2(0,0) end
  function get.up() return Vector2(0,1) end
  function get.right() return Vector2(1,0) end
  function get:magnitude() return sqrt(self[1]^2+self[2]^2) end
  function get:sqrMagnitude() return self[1]^2+self[2]^2 end
  function get:normalized()
    local m = Vector2.Magnitude(self)
    return Vector2(self[1]/m,self[2]/m)
  end
  function get:x() return self[1] end
  function get:y() return self[2] end
  function set:x(v) self[1]=v end
...
do
  ...
  Vector4.__index = function(t,k)
    if DEBUG then
      logd('Vector4.__index k=%s trace=%s', k, debug.traceback())
    end
...
--[[
  ...
  function Vector4.__add( a,b )
    return Vector4(a[1]+b[1],a[2]+b[2],a[3]+b[3],a[4]+b[4])
  end
...
if false then--PLATFORM == 'ios' then
  ...
  function Vector4.__mul( a,b )
    return Vector4(a[1]*b,a[2]*b,a[3]*b,a[4]*b)
  end
  ...
  function Vector4.__unm( a )
    return Vector4(-a[1],-a[2],-a[3],-a[4])
  end

  function get.one() return Vector4(1,1,1,1) end
  function get.zero() return Vector4(0,0,0,0) end
  function get:x() return self[1] end
  function get:y() return self[2] end
  function get:z() return self[3] end
  ...
  function get:normalized()
    ...
    return Vector4(self[1]/m,self[2]/m,self[3]/m,self[4]/m)
  end
  function set:x(v) self[1]=v end
  function set:y(v) self[2]=v end
  function set:z(v) self[3]=v end
...
do
  ...
  if not rawget(_G, 'UnityEngine.Quaternion.OldInstance') then
    rawset(_G, 'UnityEngine.Quaternion.OldInstance',
  ...
  Quaternion.__index = function(t,k)
    if DEBUG then
      logd('Quaternion.__index k=%s trace=%s', k, debug.traceback())
    end
...
--[[
  ...
  function get.identity() return Quaternion(0,0,0,1)  end
  function get:x() return self[1] end
  function get:y() return self[2] end
  function get:z() return self[3] end
  function get:w() return self[4] end
  ...
  function Quaternion:ToAngleAxis()
    ...
    return angle,Vector3(self[1]*div,self[2]*div,self[3]*div)
  end
  ...
  function Quaternion.Euler( x,y,z )
    ...
    local qX=Quaternion(sX, 0, 0, cX)
    local qY=Quaternion(0, sY, 0, cY)
    local qZ=Quaternion(0, 0.0, sZ, cZ)
  ...
  function Quaternion.Lerp( q1,q2,t )
    local tmpQuat=Quaternion(0,0,0,1)
    if Quaternion.Dot(q1, q2) < 0 then
      Quaternion.Set(tmpQuat,
                  q1[1] + t * (-q2[1] - q1[1]),
                  q1[2] + t * (-q2[2] - q1[2]),
                  q1[3] + t * (-q2[3] - q1[3]),
                  q1[4] + t * (-q2[4] - q1[4]))
