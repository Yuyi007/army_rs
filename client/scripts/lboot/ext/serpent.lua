...
local function s(t, opts)
  ...
  local function val2str(t, name, indent, insref, path, plainindex, level)
    ...
    and (mt.__persist or mt.__tostring) then -- knows how to serialize itself
      seen[t] = insref or spath
      if mt.__persist then t = mt.__persist(t)() else t = tostring(t) end
