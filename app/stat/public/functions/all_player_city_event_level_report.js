Ext.application({
  name: 'all_player_ciyt_event_level_report',
  launch: onLaunch
});
...
function onLaunch()
{
  ...
  function onBtnQuery()
  {
    ...
    g_search_name = zone_input.getRawValue() + "_" + sdk_input.getRawValue() + "_" + platform_input.getRawValue() + "_"  + date_end.getRawValue() + "_" + "所有角色入世等级分布";

    ajaxCall({
            'url'   : '/statshelper/get_all_player_city_event_level_report',
