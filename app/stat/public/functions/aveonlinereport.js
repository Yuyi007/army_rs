...
function onLaunch()
{
  ...
  {
    fields.push('h'+ i)
    columns.push({ text: ''+(i+1)+'点', dataIndex: 'h'+i});
  }
  ...
  { 
    ...
    g_search_name = "" +zone_id+ "区平均在线";
    ajaxCall({ 
        'url'   : '/realtimestats/get_ave_online_report',
