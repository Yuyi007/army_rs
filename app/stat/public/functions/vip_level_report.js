...
{ 
 ...
 var store_zone = Ext.create('Ext.data.Store', { fields: ['zone_name', 'zone_id']});
  ...
  { 
    ...
    g_search_name = zone_input.getRawValue() + "_" + sdk_input.getRawValue() + "_" + platform_input.getRawValue() + "_" + "vip等级分布" + "_" + date_input.getRawValue();

    ajaxCall({ 
        'url'   : '/statshelper/get_vip_level_report',
