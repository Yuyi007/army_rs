...
{ 
  ...
  { 
    ...
    g_search_name = zone_input.getRawValue() + "_" + "玩家等级分布" + "_" + date_input.getRawValue();

    ajaxCall({ 
        'url'   : '/statsorign/get_chief_level_report',
