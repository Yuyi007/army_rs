...
{ 
  ...
  { 
    ...
    g_search_name =zone_input.getRawValue() + "_" + sdk_input.getRawValue() + "_" + platform_input.getRawValue() + "_" + "开服狂欢报表" + "_" + date_input.getRawValue();

    ajaxCall({ 
        'url'   : '/statshelper/get_born_quest_report',
