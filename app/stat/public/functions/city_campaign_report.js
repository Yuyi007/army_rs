...
function onLaunch()
{
	...
	function onBtnQuery()
  {
    ...
    g_search_name = zone_input.getRawValue() + "_" + sdk_input.getRawValue() + "_" + platform_input.getRawValue()+ "_" + date_input.getRawValue() + "战斗参与按城区统计";

    ajaxCall({
        'url'   : '/statshelper/get_city_campaign_report',
