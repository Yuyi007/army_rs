...
function onLaunch()
{
	var fields = ['date', 'zone_id', "platform", "sdk", 'qid', 'num'];
  var columns = [ { text: '日期',  dataIndex: 'date'},
                  { text: '区',  dataIndex: 'zone_id' },
                  { text: '平台',  dataIndex: 'platform' },
                  { text: 'sdk',  dataIndex: 'sdk' },
                  { text: '任务Tid',  dataIndex: 'qid' },
  ...
  { 
    ...
    g_search_name = zone_input.getRawValue() + "_" + date_input.getRawValue() + "主线任务全部统计";
    ...
    ajaxCall({ 
        'url'   : '/statshelper/get_main_quest_user_report',
