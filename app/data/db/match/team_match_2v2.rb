class TeamMatch2V2
	...
	def match_Pair_I(groupid, count)
		...
		while @team_infos[groupid] and @team_infos[groupid].size >= count 
			...
			if pick_team_part_I(PAIR_RIGHT, 2, 1) 				# 2
				push_team_pair()	

			elsif 	pick_team_part_I(PAIR_RIGHT, 1, 2) 			# 1 1 
				push_team_pair()
